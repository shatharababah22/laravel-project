         ...
         text: '{{ session('cancel') }}',
                ...
                <div class="d-flex justify-content-end ">
                    <a href="{{ route('medicine.create') }}"
                        class="btn py-2 px-lg-4 mb-2 rounded-0 d-none d-lg-block form-submit"
                    ...
                    <tbody>
                        ...
                        @foreach ($medicine as $medicine)
                            <tr>
                                ...
                                <td><a href="#"><img src="/images/{{ $medicine->main_picture }}" width="100px"
                                ...
                                <td>
                                    <div class="description-preview">
                                        ...
                                        @if (strlen($medicine->description) > 100)
                                            <span class="show-more" onclick="showFullDescription(this)"><a
                                                    href="{{ route('medicine.show', $medicine->id) }}"
                                                    class="show-more">...Show more</a>
                                            </span>
                                            <span class="full-description">{{ substr($medicine->description, 100) }}</span>
                                            <!-- Hidden by default -->
                                        @endif
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div style="display: grid; grid-template-columns: auto auto;">
                                        ...
                                        <form id="delete-form-{{ $medicine->id }}" method="POST"
