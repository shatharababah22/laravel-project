    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="d-flex justify-content-start ">
                <a href="{{ route('medicine.index') }}" class="btn py-2 px-lg-4 mb-2 rounded-0 d-none d-lg-block form-submit" style="border-radius: 10px; width: 110px; color: rgb(10, 10, 105);"><i class="fas fa-arrow-left ms-1"></i>  back</a>
            </div>
            <table class="table">
